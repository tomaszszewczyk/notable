...
const PopoverNoteAttachments = ({
  ...
  <Popover
    open={isEditing}
    onBeforeClose={() => _.defer(() => toggleEditing(false))}
    anchor=".popover-note-attachments-trigger"
    className="popover-note-attachments"
  >
    <FixedList
      className="popover-note-attachments-list card-block"
      data={attachments}
      fallbackEmptyMessage="No attachments"
    >
      {Attachment}
    </FixedList>
    <div
      className="card-footer button compact bordered small"
