  ...
  get = async (): Promise<string> => {
    function transform(doc: Document) {
      ...
      $html
        ...
        .children()
        .not(
          'meta[charset], style:not([data-critical]), link[rel="stylesheet"]'
        )
        .remove();
      ...
      $html
        .find(".tree, .list, .list-notes, .resizable, .xsmall")
        .removeClass("tree list list-notes resizable xsmall");
    ...
    ); //TODO: This shouldn't be necessary, and won't scale with custom themes
