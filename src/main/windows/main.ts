        ...
        submenu: [
          ...
          },
          {
            ...
            enabled:
              flags &&
              flags.hasNote &&
              flags.isNoteTemplate &&
              !flags.isMultiEditorEditing,
          ...
          {
            label:
              flags && flags.hasNote && flags.isEditorEditing
                ? "Stop Editing"
                : "Edit",
            ...
            enabled:
              flags &&
              flags.hasNote &&
              !flags.isEditorSplitView &&
              !flags.isMultiEditorEditing,
            click: () => this.win.webContents.send("note-edit-toggle"),
          },
          {
            label:
              flags && flags.hasNote && flags.isTagsEditing
                ? "Stop Editing Tags"
                : "Edit Tags",
          ...
          {
            label:
              flags && flags.hasNote && flags.isAttachmentsEditing
          ...
          {
            label:
              flags && flags.hasNote && flags.isNoteFavorited
                ? "Unfavorite"
                : "Favorite",
          ...
          {
            label:
              flags && flags.hasNote && flags.isNotePinned ? "Unpin" : "Pin",
            enabled: flags && flags.hasNote && !flags.isMultiEditorEditing,
