...
const PopoverNoteTags = ({ tags, isEditing, toggleEditing, replaceTags }) => (
  <Popover
    ...
    anchor=".popover-note-tags-trigger"
    className="popover-note-tags"
  >
    <FixedList
      className="popover-note-tags-list card-block"
      data={tags}
      fallbackEmptyMessage="No tags"
    >
      {Tag}
    </FixedList>
    <Tagbox
      ...
      tags={_.clone(tags)}
      onChange={(tags) => replaceTags(undefined, Tags.sort(tags))}
    />
  </Popover>
);
